...
- (int)registerSensor:(ReanimatedSensorType)sensorType interval:(int)interval iosReferenceFrame:(int)iosReferenceFrame setter:(void (^)(double[], int))setter
{
  ReanimatedSensor *sensor = [[ReanimatedSensor alloc] init:sensorType interval:interval iosReferenceFrame:iosReferenceFrame setter:setter];
